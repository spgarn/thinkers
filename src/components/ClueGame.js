...
const CLUES = [
    ...
    {
        id: 2,
        hint: "🎵 'Game Thrones' ... 'Lord the Rings' ... 'Pirates the Caribbean' 🎬 What's missing?",
    ...
    {
        id: 5,
        hint: "🔤 It's what you get on a test if you're almost perfect",
        subHint: "What letter comes right before B in the alphabet?",
        answerWord: "A",
        acceptedAnswers: ["a"],
    },
    {
